...
<form action="relationinput.do" method="post" >
	...
	<td><input id="relation_telephone" name="relation_telephone"  type="text" placeholder="工作单位"/></td>
	<td><input id="relation_workunits" name="relation_workunits"  type="text" placeholder="联系电话"/></td>
